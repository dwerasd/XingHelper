...
public:
	...
	// 실시간 관련
	BOOL AdviseRealData(LPCSTR pszTrNo, LPCSTR pszData = "", const int nDataUnitLen = 0, const HWND _hWnd = hDefaultWnd);
	...
	BOOL	UnadviseRealData(LPCSTR pszTrNo, LPCSTR pszData = "", const int nDataUnitLen = 0, const HWND _hWnd = hDefaultWnd) const;
	BOOL	UnadviseWindow(HWND _hWnd = hDefaultWnd) const;
